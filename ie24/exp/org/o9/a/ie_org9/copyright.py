...
def CopyRight(data):
    ...
    clean_org_names = pd.read_excel( os.path.join( os.environ['WORK_DAT'], 'org','o9','data.xlsx') )
    ...
    #matches = awesome_cossim_top(tf_idf_matrix, tf_idf_matrix.transpose(), 10)
    from sparse_dot_topn import sp_matmul, sp_matmul_topn
    matches = sp_matmul(tf_idf_matrix, tf_idf_matrix.transpose(), 10)
